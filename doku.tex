...
Die Simulation und die Controller l{\"{a}}ufen auf dem NeXTStep Betriebssystem und kommunizieren {\"{u}}ber CORBA miteinander\cite{predictablecorba}, w{\"{a}}hrend
das Anzeigeprogramm Java basiert ist und z.B. auf einem Windowsrechner laufen kann.

\todo{warum meins doller ist. Graphisch in die Jahre gekommen? Kein Mensch
weiss was mehr CORBA ist? Einarbeitungszeit in CORBA?}
...
Dieses System hat allerdings physikalische Beschr{\"{a}}nkungen die es sehr
