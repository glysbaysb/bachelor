...
Netzwerklibraries die in C++ geschrieben wurden, k{\"{o}}nnen zwar (mit einem Interface) auch unter C benutzt werden, f{\"{u}}gen dem Programm dann aber "heimlich" die C++ Runtime hinzu. Eine rein in C geschreibene Library tut dies nicht und ist deswegen vorzuziehen, damit den Studenten die Sprachwahl nicht eingeschr{\"{a}}nkt wird.
