...
\begin{itemize}
\item tja funktioniert halt. ka, cih hab 3 getestet und bei keinem ist was vernuenftiges rausgekommen
\item Es ist ein systematischer Code der es erlaubt w{\"{a}}hrend des laufenden Betriebes die Pakete mitzuschneiden
	und sich die Daten anzugucken. Beispielsweise bei einem Viterbicode w{\"{a}}re dies nicht m{\"{o}}glich, dort
