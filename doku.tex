...
\begin{align}
	\Theta(t) &= \frac{R}{L} \int_0^t \mathrm{v_R(t) - v_L(t)}\mathrm{d}t \label{diff-theta}\\
	x(t) &= \frac{1}{2} \int_0^t \mathrm{(v_R(t) + v_L(t)) * \cos\big(\Theta(t)\big)}\mathrm{d}t \label{diff-x}\\
	y(t) &= \frac{1}{2} \int_0^t \mathrm{(v_R(t) - v_L(t)) * \cos\big(\Theta(t)\big)}\mathrm{d}t \label{diff-y}
\end{align}
\end{subequations}
