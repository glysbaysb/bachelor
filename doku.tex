...
Innerhalb der Welt muss eine F{\"{u}}llstation platziert werden, um den Roboter die M{\"{o}}glichkeit zu geben sich aufzuladen. Auch diese wird durch ihren Vektor $ F = \bigl(\begin{smallmatrix} x \\ y \\ w \end{smallmatrix}\bigr)$ beschrieben.
...
wird dieser Roboter aufgeladen. Die Ladefunktion folgt dabei einer e-Kurve:
$$ e(N_i, n{\"{a}}chste Runde) = 100 + (e(N_i, diese Runde) - 100) * exp{-1 \over 2}  $$
