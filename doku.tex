...
bereits besthende Systeme dieser Arbeit gegeben.
...
die Arme treffen ist eine Klappe die den Luftstrom an einem Arm nach oben herausleiten kann.

Die verschiedenen Komponenten h{\"{a}}ngen an drei verschiedenen Rechnern\footnote{jeweils mit eigenem Temperatursensor}:
\begin{itemize}
...
Diese Rechner k{\"{o}}nnen {\"{u}}ber UDP oder I\textsuperscript{2}C miteinander kommunizieren. Diese Kommunikationswege, oder sogar der ganze Rechner, k{\"{o}}nnen
allerdings zu jedem Zeitpunkt ausfallen -- es ist also notwendig das System ausfallsicher zu designen.

\todo{warum ist meins doller? Man sieht schneller was, es ist interaktiv, man muss mit mehr als 3 Rechnern arbeiten?}
