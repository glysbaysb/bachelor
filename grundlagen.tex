...
\todo{bla bla dadurch das es verschiedene systembestandteile gibt bla bla kommunikation noetig, bla bla
verschiedene moeglichkeiten bla bla einige vorgestellt bla bla dann ausgewaehlt}
...
\todo{darf ich mich hier auf die simulation beziehen? es wird ja eigentlich nur zur verdeutlichung
eines allgemeinen Problemes benutzt}
