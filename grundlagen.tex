...
Dies gibt auch das Bewegungsmodell vor: \hyperref[\textit{differential steering}]{diffs}, auch \textit{differential drive} genannt. Ausf{\"{u}}hrlicher wird dies im zugeh{\"{o}}rigen Unterkapitel erkl{\"{a}}rt.

\subsection{Khepera}\label{khepera}
\todo{wie gebe ich Quellen fuer einen ganzen Absatz / Sektion an?}
Die Khepera-Roboterserie existiert seit Mitte der 90er Jahre, das neuste Modell ist der Khepera IV\cite{khepera}. Dieser Roboter hat eine zylindrische Grundform mit einem Durchmesser von 140mm und einer
