...
Es gibt viele \textit{game engine}, genannt seien hier zum Beispiel Cryengine\ref{cryengine}, Unity, Blender, Source
...
\subsubsection{Unitys Grafikengine}
...
\subsubsection{Unitys Physikengine}
...
entscheiden - gleiches Problem wie in 11." denke mal das heiÃt die anforderungen klarer herausarbeiten}
