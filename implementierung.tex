...
\subsection{Fehlerinjektion - Physik umbennenenenenene}
...
Um die Bewegung fl{\"{u}}ssiger darzustellen wird zwischen den momentanen und gew{\"{u}}nschten Positionen / Winkel linear interpoliert.
\todo{umschreiben}
...
Mit diesem Wert wird nun normal weitergerechnet, also
...
Das Bewegungsmuster der Roboter ist an den \textit{differential drive}\ref{diff-drive} angelehnt. Dazu wird f{\"{u}}r den ersten Test ein
...
\todo{was habe ich geschafft, was nicht}
