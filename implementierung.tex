...
\paragraph{fakeWorldStatus} Es ist auch m{\"{o}}glich das Daten zur richtigen Zeit ankommen, aber
    verf{\"{a}}lscht wurden. Verf{\"{a}}lscht werden kann hierbei:
	\begin{itemize}
		\item X- und Y-Kippwinkel. Dabei wird einer der Werte um maximal $\pm 2\textdegree$ verf{\"{a}}lscht. Die Verf{\"{a}}lschung geschieht in 40\% der F{\"{a}}lle.
