...
In dieser Formel muss die Funktion der Geschwindigkeit zum Zeitpunkt 0 abgeleitet werden, da die Beschleunigung allerdings linear zwischen momentaner und
gew{\"{u}}nschter interpoliert wird, ist dies immer eine Konstante (vereinfacht wird hier 1 angenommen).
...
Die Weltstatusinformation beschreibt die beiden Kippwinkel der Platte und die Objekte auf dieser. Die Objekte (also Roboter & Ladestation) werden hierbei beschrieben
...
\begin{bytefield}[bitwidth=1.1em]{32}
	\bitheader{0-31} \\
	\bitbox{2}{TYPE} & \bitbox{4}{x} & \bitbox{4}{y} &
	\bitbox{4}{rot} & \bitbox{4}{m} & \bitbox{4}{id} &
	\bitbox{4}{fuel}
\end{bytefield}
\begin{bytefield}[bitwidth=1.1em]{32}
        \bitheader{0-31} \\
