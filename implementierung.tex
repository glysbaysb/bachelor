...
Zusammendfassend besteht das ganze System aus diesen Teilen:
\begin{itemize}
...
der Simulation sind hier die simulierte Welt mit ihren Robotern (und den dazuge{\"{o}}rigen Motoren/Aktoren und Sensoren), die Kommunikationswege zwischen Voter und Controller
...
Da jeder Roboter 2 Motoren hat, k{\"{o}}nnten theoretisch auch 2 Motoren kaputt gehen. Ein Roboter mit einem fehlerhaften Motor kann allerdings immernoch sinnvoll genutzt werden,
...
das nur ein Motor pro Roboter, im Vergleich zu beiden, gleichzeitig Fehler aufweisen kann.
...
Die Roboter haben ihre Aktoren um sich in der Welt zu bewegen. Damit sie sich sinnvoll bewegen, und die Platte balanciert halten, brauchen sie Informationen {\"{u}}ber den
...
Fall liegt vor wenn komplett falsche Daten geliefert werden. Komplett falsch hei{\ss}t das die Anzahl und die Positionen, Gewichte etc. der Roboter potenziell fehlerhaft an
...
beweglichen Objekten sind Ethernetkabel suboptimal, weswegen diese Funkverbindungen bevorzugen. Funkverbindungen haben aber, im Gegensatz zu ziemlich gut abgeschirmten
...
aufzuf{\"{u}}llen. Dies kann verschiedene Gr{\"{u}}nde haben: Entweder bewegt der Roboter sich unkontrolliert oder wird falsch angesteuert. Dies kann passieren
...
simulierten Fehlerarten sind im Fehlermodell{\ref{fm}} beschrieben.
