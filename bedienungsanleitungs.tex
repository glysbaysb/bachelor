...
Dazu werden jeweils zwei Unternordner, einer namens \quote{x86}, einer namens \quote{x64} angelegt in welche dann die jeweiligen vorkompilierten Dateien gelegt werden. F{\"{u}}r die
