...
beide Heizungen, einer beide L{\"{u}}fter und der dritte die Klappe.
...
Diese Rechner k{\"{o}}nnen {\"{u}}ber UDP und I\textsuperscript{2}C miteinander kommunizieren.

alles was ausfallen kann.
Diese Kommunikationswege oder sogar ganze Rechner k{\"{o}}nnen
