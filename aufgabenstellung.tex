...
Simulationswerkzeuges, das als Praktikumsaufgabe fungiert, zum Modul "Ausfallsichere Systeme" -- entfaltet,
...
Die Aufgabe dieser Bachelorarbeit ist die Konzeption einer solchen praktischen Praktikumsaufgabe. 
...
Aus all diesen Gr{\"{u}}nden wurde entschieden, eine neue Praktikumsaufgabe zu entwickeln. Bei dieser wird
...
Da es nicht m{\"{o}}glich sein soll die neue Praktikumsaufgabe zu besch{\"{a}}digen, muss es eine reine Softwareaufgabe
