...
\begin{figure}
	\centering
	\includevisio[\textwidth]{k4-detail1.png}
...
Das Ziel dieser Simulation war zu demonstrieren, dass auch in Echtzeitsystemen eine Konsensfindung m{\"{o}}glich
...
Einhaltung der Echtzeitanforderungen nicht mehr garantiert werden kann. \todo{die neue sache aber halt nicht} 
